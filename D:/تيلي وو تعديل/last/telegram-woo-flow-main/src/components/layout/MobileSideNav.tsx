...
const navItems = [
  ...
  { path: "/google-drive", label: "جوجل درايف", icon: HardDrive, description: "تضمين وتصفح ملفات Drive" },
  { path: "/about-tool", label: "عن الأداة والمهندس", icon: Sparkles, description: "معلومات عنا" },
